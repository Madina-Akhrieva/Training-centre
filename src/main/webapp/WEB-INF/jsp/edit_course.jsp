...
<div class="main-w3layouts wrapper">
	...
	<div class="main-agileinfo">
		<div class="agileits-top">
			<form name="course-form" action="/controller?command=submit_edit_course&&id=${requestScope.courseId}"
			      method="post">
				<input class="text" type="text" name="title" placeholder="Title (2-70 symbols [0-9a-zA-Z .,'-])"
				       maxlength="70" minlength="2" pattern="^[a-zA-Z][0-9a-zA-Z .,'-]*$" required value="${course.title}">
				<br><br>
				...
				<input class="text w3lpass" type="text" name="description"  placeholder="Description (2-50 symbols) [0-9a-zA-Z .,'-]"
