...
public enum ShowAfterDeletePageCommand implements Command {
    ...
    private static final String MAIN_PAGE = "page.manage_courses";

    private final EntityService<Course> service;
    private final RequestFactory requestFactory;
    private final PropertyContext propertyContext;

    ShowAfterDeletePageCommand(EntityService<Course> service, RequestFactory requestFactory, PropertyContext propertyContext) {
