...
public enum ShowAfterAddCoursePageCommand implements Command {
    ...
    private static final String MAIN_PAGE = "page.after_add_course";

    private final EntityService<Course> service;
    private final RequestFactory requestFactory;
    private final PropertyContext propertyContext;

    ShowAfterAddCoursePageCommand(EntityService<Course> service, RequestFactory requestFactory, PropertyContext propertyContext) {
