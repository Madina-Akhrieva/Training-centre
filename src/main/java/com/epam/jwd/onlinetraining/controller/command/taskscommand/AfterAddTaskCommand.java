...
public enum AfterAddTaskCommand implements Command {
    INSTANCE(RequestFactory.getInstance(), PropertyContext.instance());

    private static final String ADD_COURSE = "page.after_add_task";

    private final RequestFactory requestFactory;
    private final PropertyContext propertyContext;

    AfterAddTaskCommand(RequestFactory requestFactory, PropertyContext propertyContext) {
